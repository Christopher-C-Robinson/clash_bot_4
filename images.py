...
class Image:
            ...
            if "troops" in file:
                try:
                    ...
                    self.image = cv2.resize(
                        cv2.imread(file, 0), (0, 0), fx=scale, fy=scale
                    )
                except:
                    self.image = None
    ...
    def find_detail(self, show_image=False, fast=False):
        ...
        rect = (
            loc[0] + region_limit_x,
            loc[1] + region_limit_y,
            self.image.shape[1],
            self.image.shape[0],
        )
        loc = (
            int(rect[0] + rect[2] / 2 + region_limit_x),
            int(rect[1] + rect[3] / 2 + region_limit_y),
        )
    ...
    def find_screen(
        self, screen, show_image=False, return_location=False, return_result=False
    ):
        if self.image is None:
            print("Find - No image provided:", self.name)
            return False, (0, 0)
        ...
        result = cv2.matchTemplate(screen, self.image, method)
        min_val, val, min_loc, loc = cv2.minMaxLoc(result)
        if return_result and return_location:
            return val > self.threshold, round(val, 2), loc
        if return_result:
            return val > self.threshold, round(val, 2)
        if return_location:
            return val > self.threshold, loc
        return val > self.threshold
    ...
    def check_region_limit(self, region):
        if self.region_limit is None:
            return True
        within_region = True
        if region[0] < self.region_limit[0]:
            within_region = False
        if region[1] < self.region_limit[1]:
            within_region = False
        if region[0] + region[2] > self.region_limit[0] + self.region_limit[2]:
            within_region = False
        if region[1] + region[3] > self.region_limit[1] + self.region_limit[3]:
            within_region = False
    ...
    def merge_regions(self):
        ...
        for region_a in self.regions:
            for region_b in self.regions:
                ...
                if (
                    ...
                    and region_a[1] == region_b[1]
                    and region_a[2] == region_b[2]
                    and region_a[3] == region_b[3]
                ):
        ...
        if (
            len(self.regions) <= self.no_of_regions
            and min_increase
            and min_increase > 0
        ):
            return False
...
i_change_accounts_button = Image(
    name="i_change_accounts_button", file="images/nav/change_accounts_button.png"
)
...
i_maintenance = Image(
    name="i_maintenance", file="images/nav/maintenance.png", threshold=0.9
)
...
i_pycharm_running = Image(
    name="i_pycharm_running", file="images/nav/pycharm_running.png"
)
...
i_red_cross_settings = Image(
    name="i_red_cross_settings", file="images/nav/red_cross_settings.png"
)
i_red_cross_attack = Image(
    name="i_red_cross_attack", file="images/nav/red_cross_attack.png"
)
i_red_cross_clan = Image(name="i_red_cross_clan", file="images/nav/red_cross_clan.png")
i_red_cross_super_troops = Image(
    name="i_red_cross_super_troops",
    file="images/super_boost/red_cross_super_troops.png",
)
...
i_return_home_2 = Image(
    name="i_return_home_2", file="images/nav/return_home_2.png", threshold=0.7
)
...
i_settings_on_main = Image(
    name="i_settings_on_main", file="images/nav/settings_on_main.png"
)
...
i_spells_tab_dark = Image(
    name="i_spells_tab_dark", file="images/nav/spells_tab_dark.png"
)
...
i_close_switch_account = Image(
    name="i_close_switch_account", file="images/nav/close_switch_account.png"
)
...
i_troops_tab_dark = Image(
    name="i_troops_tab_dark", file="images/nav/troops_tab_dark.png"
)
...
i_raid_medals = Image(
    name="i_raid_medals", file="images/nav/raid_medals.png", threshold=0.95
)
i_raid_medals_selected = Image(
    name="i_raid_medals_selected",
    file="images/nav/raid_medals_selected.png",
    threshold=0.95,
)
...
i_coin_on_main_screen = Image(
    name="coin_on_main_screen", file="images/capital_coin/coin_on_main_screen.png"
)
i_coin_collect = Image(name="coin_collect", file="images/capital_coin/coin_collect.png")
i_red_cross_coin = Image(
    name="red_cross_coin", file="images/capital_coin/red_cross_coin.png"
)
...
i_remove_troops = Image(
    name="i_remove_troops", file="images/remove_troops.png", threshold=0.79
)
i_remove_troops_army = Image(
    name="i_remove_troops_army", file="images/remove_troops_army.png", threshold=0.79
)
i_remove_troops_castle = Image(
    name="i_remove_troops_castle",
    file="images/remove_troops_castle.png",
    threshold=0.79,
)
...
i_red_cross_games = Image(
    name="i_red_cross_games", file="images/nav/red_cross_games.png"
)

# Research
i_research = Image(name="i_research", file="images/research/research.png")
i_research_upgrading = Image(
    name="i_research", file="images/research/research_upgrading.png"
)
i_research_elixir = Image(
    name="i_research_elixir", file="images/research/research_elixir.png"
)
...
i_star_bonus_okay = Image(
    name="surrender_b_okay", file="images/attack_b/okay_star_bonus.png"
)
# i_war_elixir_cart = Image(name="war_elixir_cart", file="images/attack_b/war_elixir_cart.png")
i_collect_elixir = Image(
    name="collect_elxir", file="images/attack_b/collect_elixir.png"
)
i_red_cross_elixir_cart = Image(
    name="red_cross_elixir_cart", file="images/attack_b/red_cross_elixir_cart.png"
)
# Attack_b troops
...
i_attack_screen_resources = Image(
    name="attack screen resources", file="images/attack_screen_resources.png"
)
...
i_warden_activate = Image(
    name="warden_activate", file="images/troops/warden_activate.png"
)
...
i_war_left = Image(
    name="i_war_left",
    file="images/war/left.png",
    threshold=0.7,
    region_limit=[415, 700, 500, 240],
)
...
i_war_donate_reinforcements = Image(
    name="i_war_donate_reinforcements",
    file="images/war/donate_reinforcements.png",
    threshold=0.7,
)
...
i_attacks_available = Image(
    name="i_attacks_available", file="images/war/attacks_available.png"
)
...
# Challenge
i_challenge_start = Image(
    name="challenge_start", file="images/challenge/challenge_start.png"
)

# Building images
i_builder_zero = Image(
    name="i_builder_zero",
    file="images/builder_zero.png",
    threshold=0.75,
    region_limit=[744, 79, 198, 32],
)
i_builder_one = Image(
    name="i_builder_one", file="images/builder_one.png", threshold=0.75
)
i_upgrade_button = Image(
    name="i_upgrade_button", file="images/upgrade.png", threshold=0.7
)
i_upgrade_2_button = Image(
    name="i_upgrade_button", file="images/upgrade_2.png", threshold=0.7
)
i_confirm = Image(file="images/upgrade/confirm.png")
i_upgrade_hero_button = Image(
    name="i_upgrade_hero_button", file="images/upgrade_hero.png", threshold=0.7
)
i_build_confirm = Image(name="build_confirm", file="images/builder/build_confirm.png")
i_build_confirm_2 = Image(
    name="build_confirm", file="images/builder/build_confirm_2.png"
)
i_suggested_upgrades = Image(
    name="i_suggested_upgrades", file="images/towers/suggested_upgrades.png"
)
i_upgrades_in_progress = Image(
    name="i_upgrades_in_progress", file="images/towers/upgrades_in_progress.png"
)
...
i_army_donate_edit = Image(
    name="i_army_donate_edit", file="images/nav/army_donate_edit.png"
)
...
i_castle_confirm = Image(
    name="i_castle_confirm", file="images/castle/castle_confirm.png"
)
...
i_war_classic_off = Image(
    name="i_war_classic_off", file="images/nav/war_classic_off.png"
)
i_war_league_on = Image(name="i_war_league_on", file="images/nav/war_league_on.png")
...
i_find_new_members = Image(
    name="i_find_new_members", file="images/people/find_new_members.png"
)
...
i_request_reinforcements = Image(
    name="request_reinforcements", file="images/nav/request_reinforcements.png"
)
...
i_boost_on = Image(
    name="i_boost_on", file="images/super_boost/boost_on.png", threshold=0.7
)
i_boost_on_2 = Image(
    name="i_boost_on", file="images/super_boost/boost_on.png", threshold=0.7
)
...
i_super_minion = Image(
    name="i_super_minion", file="images/super_boost/super_minion.png"
)
...
i_potion_small = Image(
    name="i_potion_small", file="images/super_boost/potion_small.png"
)
...
def create_image_group(directory, show=False, threshold=0.79, add_levels=False):
    ...
    for file in files:
        ...
        new = Image(
            name=file, file="images/" + file + ".png", threshold=threshold, level=level
        )
...
for file in files:
    new = Image(
        name=file, file="images/" + file + ".png", threshold=0.69, no_of_regions=1
    )
...
member_castles = []
for file in files:
    member_castles.append(
        Image(name=file, file="images/" + file + ".png", threshold=0.65)
    )
