...
def attack_troops_required(data):
    troops_required = []
    for d in data:
        if d[0] == "place":
            troops_required += [d[1]] * d[2]
        if d[0] == "earthquake":
            troops_required += [quake] * 11
...
ROOT = [
    ...
    ("rage_th", ),
    ("earthquake", ),
    ("place", super_barb, 1, 0.8),
    ("place", root, 1, 0.8), ("place", super_barb, 3, 0.8),
    ("place", champ, 1, 0.5),
    # ("place", root, 1, 0.8), ("place", super_barb, 4, 0.8),
    # ("place", root, 1, 0.8), ("place", super_barb, 4, 0.8),
    # ("place", root, 1, 0.8), ("place", super_barb, 4, 0.8),
    # ("place", root, 1, 0.8), ("place", super_barb, 4, 0.8),
    # ("place", root, 1, 0.8), ("place", super_barb, 4, 0.8),
...
BARBS_52 = [
    ("earthquake", ),
    ("place", king, 1, 0.5),
    ("place", log_thrower, 1, 0.5),
    ("place", queen, 1, 0.5),
    ("place", warden, 1, 0.5),
    ("place", champ, 1, 0.5),
    ("place", super_barb, 10, 0.8),
    ("ability", warden),
    ("place", super_barb, 10, 0.8),
    ("ability", king),
    ("place", super_barb, 10, 0.8),
    ...
    ("place", super_barb, 10, 0.8),
    ("ability", champ),
    ("place", super_barb, 12, 0.8),
]

BARBS_56 = BARBS_52 + [("place", super_barb, 4, 0.8)]
BARBS_60 = BARBS_52 + [("place", super_barb, 8, 0.8)]
BARBS_64 = BARBS_52 + [("place", super_barb, 12, 0.8)]
