...
TRAIN_RANGE = (287, 542, 1600, 370)
TRAINING_RANGE = (287, 249, 1600, 150)
TRAINING_RANGE_SIEGE = (910, 180, 830, 150)
DELETE_REGION = (1650, 200, 100, 60)
DELETE_2_REGION = (1520, 200, 100, 60)
ARMY_EXISTING = (284, 268, 1300, 160)
SPELLS_EXISTING = (282, 500, 950, 175)
SIEGE_EXISTING = (1284, 210, 450, 200)
ARMY_CREATE = (145, 534, 1520, 370)
END_ATTACK_SPOT = (75,675,250,150)
ARMY_CLOCK_SPOT = (920,145,100,100)
CASTLE_TROOPS = (147, 753, 1320, 190)
...
WAR_BANNER = (790, 145, 300, 140)
WAR_DONATION_COUNT = (810, 774, 80, 24)
...
# Clans
MEMBER_NUMBERS =(830, 800, 100,45)
STARS = (1350, 600, 100, 55)
